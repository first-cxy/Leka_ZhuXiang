...
public class LCPMessage {
    ...
    public static final byte EV3_INFOPROGRAM = 0x0C;
    
    public static final byte OP_SOUND = (byte)0x94;
    ...
    public static byte[] getEV3BeepMessage(int frequency, int duration) {
        ...
        message[8]=(byte)0x55;
        message[9]=(byte)0x82;
        message[10]=(byte) frequency;
        message[11]=(byte) (frequency >> 8);
        message[12]=(byte)0x82;
        message[13]=(byte) duration;
        message[14]=(byte) (duration >> 8);

        return message;
    }
    
    public static byte[] getEV3StartProgramMessage(int pos, String path, String name) {
    	String fn="";
    	if (path=="")
    		fn=name;
    	else
    		fn=path+"/"+name;
    	int len=fn.length()+35;
    	if (pos==1)
    		len=fn.length()+29;
        ...
        {
        	message[9] = (byte)0x2F;
        	message[10] = (byte)0x6D;
        	message[11] = (byte)0x65;
        	message[12] = (byte)0x64;
        	message[13] = (byte)0x69;
        	message[14] = (byte)0x61;
        	message[15] = (byte)0x2F;
        	message[16] = (byte)0x63;
        	message[17] = (byte)0x61;
        	message[18] = (byte)0x72;
        	message[19] = (byte)0x64;
        	message[20] = (byte)0x2F;
        }
        else
        {
        	p=27;
            message[9]=(byte)0x2F;
            message[10]=(byte)0x6D;
            message[11]=(byte)0x6E;
            message[12]=(byte)0x74;
            message[13]=(byte)0x2F;
            message[14]=(byte)0x72;
            message[15]=(byte)0x61;
            message[16]=(byte)0x6D;
            message[17]=(byte)0x64;
            message[18]=(byte)0x69;
            message[19]=(byte)0x73;
            message[20]=(byte)0x6B;
            message[21]=(byte)0x2F;
            message[22]=(byte)0x70;
            message[23]=(byte)0x72;
            message[24]=(byte)0x6A;
            message[25]=(byte)0x73;
            message[26]=(byte)0x2F;
        }
        for (int i=0; i<fn.length(); i++)
            message[p++] = (byte) fn.charAt(i);        
        message[p++] = (byte)0x00;
        message[p++] = (byte)0x40;
        message[p++] = (byte)0x44;
        message[p++] = (byte)0x03;
    ...
    public static byte[] getEV3InfoProgramMessage() {
    ...
    public static byte[] getEV3MotorMessage(int motor, int speed) {
        byte[] message = new byte[12];
        message[0]=(byte)0x00;
        message[1]=(byte)0xA5;
        message[2]=DIRECT_COMMAND_NOREPLY;
        ...
        message[5]=(byte)0xA5;
        message[6]=(byte)0x00;
        message[7]=(byte)motor;
        message[8]=(byte)speed;
        message[9]=(byte)0xA6;
        message[10]=(byte)0x00;
        message[11]=(byte)motor;
        return message;
    }
	...
	public static byte[] setLightMessage(int i) {
	...
	public static byte[] getValueMessage() {
        byte[] message = new byte[3];
        message[0] = DIRECT_COMMAND_REPLY;
